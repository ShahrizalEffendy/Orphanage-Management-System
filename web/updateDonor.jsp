   ...
   <div style="text-align: center;">
    ...
    <div class="container">
       ...
       <h1>Update Donor</h1>
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    %>
                        ...
                        <table>
                    <form action="UpdateDonorServlet" method="POST" onsubmit="return validateForm()">
                        <input type="hidden" name="id" value="<%= id%>">
                        <label for="name">Name:</label>
                        <input type="text" id="name" name="name" value="<%= name %>"><br><br>                         
                        <label for="age">Address:</label>
                        <input type="text" id="age" name="address" value="<%= address %>"><br><br>
                        <label for="gender">Contact No:</label>
                        <input type="text" id="gender" name="contactno" value="<%= contactno %>"><br><br>
            ...
            %>
        <a href="donor_info.jsp"><button>Back</button></a>
            </article>
    </section>
</body>
</html>
