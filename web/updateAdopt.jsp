<%@page import="controller.UpdateAdoptServlet"%>
    ...
    <div class="container">
       ...
       <h1>Update Adopt</h1>
            ...
            try {
                ...
                String sql = "SELECT * FROM adopt2 WHERE id = ?";
                ...
                if (rs.next()) {
                    ...
                    %>
                        ...
                        <table>
                    <form action="UpdateAdoptServlet" method="POST" onsubmit="return validateForm()">
