<%--
    ...
    Created on : Jun 24, 2023, 4:56:43 PM
    Author     : User
--%>

<%@page import="java.sql.*"%>
<%@page import="java.util.List"%>
<%@page import="bean.ChildBean"%>
...
<body>
   ...
   <section>
       <article>
                    ...
                    try {
                        ...
                        while (resultSet.next()) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="deleteChild.jsp" method="post">
                                        <input type="hidden" name="id" value="<%= id %>">
                                        <input type="hidden" name="name" value="<%= name %>">
        ...
        <a href="child_registration.html"><button>Register Another Child</button></a><a href="admin_success.jsp"><button>Back</button></a>
      </article>
   </section>
</body>
</html>
